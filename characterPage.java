            ...
            switch (action) {
                ...
                case "Short Sword":
                    if (shortSword.getEquipped() != true) {
                        ...
                        topPanel.removeAll();
                        if (woodShield.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/wSsSMan.png")));
                        else if (stoneShield.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/sSsSMan.png")));
                        else if (ironShield.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/iSsSMan.png")));
                        else
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/ssMan.png")));
                        topPanel.add(weaponPanel);
                        topPanel.add(picLabel);
                        ...
                        if (woodShield.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/wsMan.png")));
                        else if (stoneShield.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/stsMan.png")));
                        else if (ironShield.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/isMan.png")));
                        else
                            defaultCharacter();
                        topPanel.add(weaponPanel);
                        topPanel.add(picLabel);
                ...
                case "Long Sword":
                    if (longSword.getBought()) {
                        if (longSword.getEquipped() != true) {
                            ...
                            if (woodShield.getEquipped())
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/wSlSMan.png")));
                            else if (stoneShield.getEquipped())
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/sSlSMan.png")));
                            else if (ironShield.getEquipped())
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/iSlSMan.png")));
                            else
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/lsMan.png")));
                            topPanel.add(weaponPanel);
                            topPanel.add(picLabel);
                ...
                case "Magic Wand":
                    if (magicWand.getBought()) {
                        if (magicWand.getEquipped() != true) {
                            ...
                            if (woodShield.getEquipped())
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/wSmWMan.png")));
                            else if (stoneShield.getEquipped())
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/sSmWMan.png")));
                            else if (ironShield.getEquipped())
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/iSmWMan.png")));
                            else
                                picLabel = new JLabel(
                                        new ImageIcon(getClass().getClassLoader().getResource("res/mwMan.png")));
                            topPanel.add(weaponPanel);
                            topPanel.add(picLabel);
                ...
                case "Wood Shield":
                    if (woodShield.getEquipped() != true) {
                        ...
                        topPanel.removeAll();
                        if (shortSword.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/wSsSMan.png")));
                        else if (longSword.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/wSlSMan.png")));
                        else if (magicWand.getEquipped())
                            picLabel = new JLabel(
                                    new ImageIcon(getClass().getClassLoader().getResource("res/wSmWMan.png")));
                        else
                            picLabel = new JLabel(
